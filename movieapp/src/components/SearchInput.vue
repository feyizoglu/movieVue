<template>
    <div class="flex justify-center mt-4">
      ...
      />
      <div v-if="results.length" class="absolute bg-white text-black mt-12 w-1/2 rounded-lg shadow-lg">
        <ul>
  ...
  export default {
    ...
    methods: {
      async fetchResults() {
        ...
        const response = await axios.get(`https://api.themoviedb.org/3/search/multi?api_key=348088421ad3fb3a9d6e56bb6a9a8f80&query=${this.query}`)
